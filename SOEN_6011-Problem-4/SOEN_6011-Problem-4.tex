...
\textbf{PROBLEM - 4} \\
Debugger and Quality Attributes\\
\end{Large}
\vspace*{0.9in}
\rule{80mm}{0.1mm}\\
\vspace*{0.1in}
...
\tableofcontents
\newpage
\addcontentsline{toc}{section}{a) Description on Debugger that is used }
\newpage

\addcontentsline{toc}{section}{b \& c) Quality Attributes Description }
\pagebreak
\section*{Debugger and Quality Attributes Description}
