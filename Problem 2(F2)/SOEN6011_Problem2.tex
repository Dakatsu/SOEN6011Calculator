...
The current section describes the requirements and assumptions to implement the function $tan(x)$.
\\\\
\textbf{Explicit Assumption:} 
The value of $tan(x)$ function is real number. Moreover, output of the $tan(x)$ function is in radians. For a value to be accurate, it shall be correct up to a specific number of decimal places. This number of decimal places may be specified by the system or the user.
\\\\\\\\\\
...
\textbf{Version} & 1.0 \\
\textbf{Description} & 
\begin{tabular}[c]{@{}l@{}} If User gives any non-integer value. The output will show error.
\end{tabular} \\
...
\\will be undefined and will show error.
\end{tabular} \\
\textbf{Owner} & Rokeya Begum Keya \\
\textbf{Priority} & High \\
\textbf{Type} & Functional \\
