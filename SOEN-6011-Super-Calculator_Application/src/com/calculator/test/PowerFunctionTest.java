...
public class PowerFunctionTest {
	...
	/**
	 * Test Case Id :  F7_TestCase_1
	 * Test cases for Requirement Id :  F7-R1
	 * test if X(0) to the power of Y(0)=1.0
	 * 
	 */
	@Test
	...
	/**
	 * Test Case Id :  F7_TestCase_2
	 * Test cases for Requirement Id :  F7-R2
	 * test if X(0) to the power of Y(Real Number)=0.0
	 * 
	 */
	@Test
	...
	/**
	 * Test Case Id :  F7_TestCase_3
	 * Test cases for Requirement Id :  F7-R3
	 * test if X(Positive Number) to the power of Y(0)=1.0
	 * 
	 */
	@Test
	...
	/**
	 * Test Case Id :  F7_TestCase_4
	 * Test cases for Requirement Id :  F7-R4
	 * test if X(Negative Number) to the power of Y (0)=1.0
	 * 
	 */
	@Test
	...
	/**
	 * Test Case Id :  F7_TestCase_5
	 * Test cases for Requirement Id :  F7-R5
	 * test if X(Positive Number) to the power of Y(1)= x
	 * 
	 */
	@Test
	...
	/**
	 * Test Case Id :  F7_TestCase_6
	 * Test cases for Requirement Id :  F7-R6
	 * test if X(Positive Number) to the power of Y(Positive Number)= Positive Number
	 * 
	 */
	@Test
	...
	/**
	 * Test Case Id :  F7_TestCase_7
	 * Test cases for Requirement Id :  F7-R7
	 * test if X(Negative Number) to the power of Y(Positive Even Number)= Positive Number
	 * 	
	 */
	@Test
	...
	/**
	 * Test Case Id :  F7_TestCase_8
	 * Test cases for Requirement Id :  F7-R8
	 * test if X(Negative Number) to the power of Y(Positive Odd Number)= Negative Number
	 * 	
	 */
	@Test
